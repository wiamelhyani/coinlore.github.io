        ...
        <div className="row">
          ...
          <div className="col-md-4">
            <Card style={{ backgroundColor: "white", color: "black" }}>
              ...
              <Divider />
              <div class="infoBox">
                <div class="infoBox__title">In cooperation with</div>
                <div class="overflow-hidden">
                  <div class="width40">
                    <div class="partner-container">
                      <a
                        class="display-inline-block margin-top-5"
                      ...
                      >
                        <img
                          height="50"
                          class="partner-logo display-inline-block max-height-50"
                          src="https://cdn.statcdn.com/Source/27873.png"
                          alt="CoinGecko"
                        />
                      </a>
                      <p class="partner-title infoBox__text hidden">
                        CoinGecko
                      </p>
                    </div>
                  </div>
